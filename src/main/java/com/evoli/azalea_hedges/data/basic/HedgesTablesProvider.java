...
public class HedgesTablesProvider extends LootTableProvider {
    public HedgesTablesProvider(DataGenerator dataGenerator) {
        super(dataGenerator);
    }
    ...
    protected List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> getTables() {
        ...
        builder.add(Pair.of(HedgesTables::new, LootContextParamSets.BLOCK));
